...
/*
 *----------------------------------------------------------------------
 *    Modified by Yuji Katori at 2023/05/16.
 *----------------------------------------------------------------------
 */
...
/* Task ID define */
#define USB_TID_1           (0u)                /* Task ID 1 */
#define USB_TID_2           (1u)                /* Task ID 2 */
#define USB_TID_4           (2u)                /* Task ID 4 */
#define USB_TID_5           (3u)                /* Task ID 5 */

/* Task priority define */
#define USB_PRI_1           (0u)                 /* Priority 1 */
#define USB_PRI_2           (1u)                 /* Priority 2 */
#define USB_PRI_3           (2u)                 /* Priority 3 */
...
#define USB_INTMSGMAX           ((uint16_t)2u)
...
#define USB_MAX_PIPE_NO                     (1u)        /* PIPE0 ... PIPE9 */
