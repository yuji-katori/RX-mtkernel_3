 ...
 *         : 20.04.2023 1.30 Modify uT-Kernel3.0 specification.
 ***********************************************************************************************************************/
...
// 例え#ifで偽と判断されても、インクルードされているファイルが存在しない場合、再コンパイルとなる
// 再コンパイルを抑止するために以下の３行はコメントアウトする
...
#ifndef __TK_TYPEDEF_H__             /* Excluding uT-Kernel */
