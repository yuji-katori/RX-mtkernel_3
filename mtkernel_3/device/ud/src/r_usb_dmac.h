...
/*
 *----------------------------------------------------------------------
 *    Modified by Yuji Katori at 2023/06/08.
 *----------------------------------------------------------------------
 */
...
#define USB_DMA_CH_PRI              (USB_CFG_INT_PRIORITY)     /* DMACmI interrupt priority level for USB Pipe : DxFIFO->buff */
#define USB_DMA_CH2_PRI             (USB_CFG_INT_PRIORITY)     /* DMACmI interrupt priority level for USB Pipe : buff->DxFIFO */
