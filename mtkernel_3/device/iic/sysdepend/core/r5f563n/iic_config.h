...
#define	USE_IIC3			/* Use RIIC3 */
#define	IIC3_HPSCL	0.6F		/* RIIC3 I2C High Period of the SCL Clock(us) */
#define	IIC3_LPSCL	1.3F		/* RIIC3 I2C Low  Period of the SCL Clock(us) */
