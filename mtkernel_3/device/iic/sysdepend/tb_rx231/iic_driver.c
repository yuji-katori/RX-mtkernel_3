...
#if defined(USE_SCL_P16)
	MPC.P16PFS.BYTE = 0x0F;					// P16 is SCL Pin
#elif defined(USE_SCL_P12)
	MPC.P12PFS.BYTE = 0x0F;					// P12 is SCL Pin
#endif
#if defined(USE_SDA_P17)
	MPC.P17PFS.BYTE = 0x0F;					// P17 is SDA Pin
#elif defined(USE_SDA_P13)
	MPC.P13PFS.BYTE = 0x0F;					// P13 is SDA Pin
#endif
	MPC.PWPR.BYTE = 0x80;					// Write Disable
#if defined(USE_SCL_P16)
	PORT1.ODR1.BIT.B4 = 1;					// SCL is Open Drain
	PORT1.PMR.BIT.B6 = 1;					// P16 is Peripheral Pin
#elif defined(USE_SCL_P12)
	PORT1.ODR0.BIT.B4 = 1;					// SCL is Open Drain
	PORT1.PMR.BIT.B2 = 1;					// P12 is Peripheral Pin
#endif
#if defined(USE_SDA_P17)
	PORT1.ODR1.BIT.B6 = 1;					// SDA is Open Drain
	PORT1.PMR.BIT.B7 = 1;					// P17 is Peripheral Pin
#elif defined(USE_SDA_P13)
	PORT1.ODR0.BIT.B6 = 1;					// SDA is Open Drain
