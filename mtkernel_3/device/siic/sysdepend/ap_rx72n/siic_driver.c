...
union { T_CTSK t_ctsk; T_CFLG t_cflg; T_DDEV t_ddev; T_DINT t_dint; } u;
	...
	SCI2.BRR = PCLKB / 32.0F / SIIC2_FSCL - 1;		// SCL Frequency
	SCI2.MDDR = (SCI2.BRR+1) * 8192.0F * SIIC2_FSCL / PCLKB;// Analize Modulation Duty
	...
	SCI3.BRR = PCLKB / 32.0F / SIIC3_FSCL - 1;		// SCL Frequency
	SCI3.MDDR = (SCI3.BRR+1) * 8192.0F * SIIC3_FSCL / PCLKB;// Analize Modulation Duty
	...
	SCI4.BRR = PCLKB / 32.0F / SIIC4_FSCL - 1;		// SCL Frequency
	SCI4.MDDR = (SCI4.BRR+1) * 8192.0F * SIIC4_FSCL / PCLKB;// Analize Modulation Duty
	...
	SCI7.BRR = PCLKA / 32.0F / SIIC7_FSCL - 1;		// SCL Frequency
	SCI7.MDDR = (SCI7.BRR+1) * 8192.0F * SIIC7_FSCL / PCLKA;// Analize Modulation Duty
	...
	SCI8.BRR = PCLKA / 32.0F / SIIC8_FSCL - 1;		// SCL Frequency
	SCI8.MDDR = (SCI8.BRR+1) * 8192.0F * SIIC8_FSCL / PCLKA;// Analize Modulation Duty
	...
	SCI9.BRR = PCLKA / 32.0F / SIIC9_FSCL - 1;		// SCL Frequency
	SCI9.MDDR = (SCI9.BRR+1) * 8192.0F * SIIC9_FSCL / PCLKA;// Analize Modulation Duty
	...
	SCI10.BRR = PCLKA / 32.0F / SIIC10_FSCL - 1;		// SCL Frequency
	SCI10.MDDR = (SCI10.BRR+1)*8192.0F*SIIC10_FSCL/PCLKA;	// Analize Modulation Duty
	...
	SCI11.BRR = PCLKA / 32.0F / SIIC11_FSCL - 1;		// SCL Frequency
	SCI11.MDDR = (SCI11.BRR+1)*8192.0F*SIIC11_FSCL/PCLKA;	// Analize Modulation Duty
