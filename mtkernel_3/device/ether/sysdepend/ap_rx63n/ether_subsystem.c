...
//	
	...
	MPC.PWPR.BIT.B0WI = 0;				// Write Protect Disable
	MPC.PWPR.BIT.PFSWE = 1;
	MPC.P77PFS.BYTE = 0x12;				// P77 is RMII_RX_ER
	MPC.P76PFS.BYTE = 0x12;				// P76 is REF50CK
	MPC.P75PFS.BYTE = 0x12;				// P75 is RMII_RXD0
	MPC.P74PFS.BYTE = 0x12;				// P74 is RMII_RXD1
	MPC.P72PFS.BYTE = 0x11;				// P72 is ET0_MDC
	MPC.P71PFS.BYTE = 0x11;				// P71 is ET0_MDIO
	MPC.P83PFS.BYTE = 0x12;				// P83 is RMII_CRS_DV
	MPC.P82PFS.BYTE = 0x12;				// P82 is RMII_TXD1
	MPC.P81PFS.BYTE = 0x12;				// P81 is RMII_TXD0
	MPC.P80PFS.BYTE = 0x12;				// P80 is RMII_TXD_EN
	MPC.PWPR.BYTE = 0x80;				// Write Protect Enable
