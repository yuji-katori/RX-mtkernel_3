 ...
 *	sysdef.h
 *
 *	System dependencies definition (R5F566N depended)
...
/* CPU Core-dependent definition (RXv3) */
#include "../core/rxv3/sysdef.h"

/* ------------------------------------------------------------------------ */
/*
 * Internal Memorie (Main RAM without saddr)  0x00000 - 0x7FFFF
 */
#define INTERNAL_RAM_TOP	0x00000
#define INTERNAL_RAM_END	0x80000
 ...
 *    There is one coprocessor for this microcomputer.
 */
