...
#define TK_WAKEUP_MAXCNT		(2147483647)		/* Maximum queuing number of the task wakeup requests. */
#define TK_SEMAPHORE_MAXCNT		(2147483647)		/* Maximum semaphore count */
/*
 * Maximum queuing count of the forced wait of tasks.
 */
#define TK_SUSPEND_MAXCNT		(2147483647)
